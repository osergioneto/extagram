defmodule Extagram.Accounts.User do
  use Ecto.Schema
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    ...
    |> validate_length(:full_name, min: 2, max: 30)
    |> validate_email()
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Extagram.Repo)
  ...
  """
  def valid_password?(%Extagram.Accounts.User{hashed_password: hashed_password}, password)
